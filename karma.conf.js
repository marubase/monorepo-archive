module.exports = function (karmaConfig) {
  karmaConfig.set({
    ...
    files: [
      { pattern: "source/browser.test.ts", watched: false },
      { pattern: "source/browser.test.cts", watched: false },
      { pattern: "source/browser.test.js", watched: false },
      { pattern: "source/browser.test.jsx", watched: false },
      { pattern: "source/browser.test.mjs", watched: false },
      { pattern: "source/browser.test.mts", watched: false },
      { pattern: "source/browser.test.ts", watched: false },
      { pattern: "source/browser.test.tsx", watched: false },
